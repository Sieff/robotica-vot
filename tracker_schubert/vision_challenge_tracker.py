...
"""
List of ideas:
- Try multiple scales and rotations of the template to account for object changes
- Mix original template with current template to retain information of original object
- Track object movement to continue movement in case of obfuscation
- Track object movement and only accept results with reasonable distance to the last object position
- Blur template and image to account for image noise 
- Search for the top n similarities and then reason about them based on their value and distance to the last position
"""
###################################################################
